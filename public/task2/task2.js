...
let task1 = new Vue({
  ...
  methods: {
    showMoves: function() {
      ...
      if (this.chessboard[y - 2] && this.chessboard[y - 2][x + 1]) {
        posibleMoves.push(this.chessboard[y - 2][x + 1]);
      };

      if (this.chessboard[y - 1] && this.chessboard[y - 1][x + 2]) {
        posibleMoves.push(this.chessboard[y - 1][x + 2]);
      };
